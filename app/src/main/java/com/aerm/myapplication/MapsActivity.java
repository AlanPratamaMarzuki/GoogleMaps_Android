...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng stikes = new LatLng(-0.8423899099491152, 119.88667966537312);
...
//        Custom Size Marker
        ...
        mMap.addMarker(new MarkerOptions().position(stikes).title("Marker in SMA NEGERI 5 PALU")
                .snippet("Ini adalah SMA Negeri 5 Palu")
                .icon(BitmapDescriptorFactory.fromBitmap(markerDes)));

        mMap.addPolyline(new PolylineOptions().add(
                untad,
                new LatLng(-0.83654767328329, 119.89230778909558),
                new LatLng(-0.8363627455697842, 119.88952455099194),
                new LatLng(-0.843398313880642, 119.89091755617953),
                new LatLng(-0.8432373972420707, 119.8868942429036),
